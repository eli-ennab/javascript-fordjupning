...
const App = () => {
	...
	return (
		<div className="App">
			...
			<button className="btn btn-light" onClick={() => setShowsalary(true)}>Show salary</button>
			<button className="btn btn-light" onClick={() => setShowsalary(false)}>Hide salary</button>
